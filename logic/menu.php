    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li <?php if(ACTIVE_PAGE === 'index') echo 'class="active"' ?>><a href="/">Home</a></li>
                <li><a id="showRules" style="cursor: pointer; cursor: hand;">Rules</a></li>
                <?php if(isset($loggedUser)): ?>
                <li <?php if(ACTIVE_PAGE === 'profile') echo 'class="active"' ?> style="margin-top: -9px"><a href="/profiles/"><img src="<?php echo $loggedUser->avatar ?>" width="32" height="32" /></a></li>
